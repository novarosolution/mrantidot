...
export const SERVICE_TYPE_META: Record<ServiceTypeKey, ServiceTypeMeta> = {
  ant: { label: SERVICE_TYPE_LABELS.ant, icon: Bug, color: '#B45309', bg: '#FEF3C7' },
  cockroach: { label: SERVICE_TYPE_LABELS.cockroach, icon: Bug, color: '#78350F', bg: '#F5F5F4' },
  rodent: { label: SERVICE_TYPE_LABELS.rodent, icon: Shield, color: '#7C2D12', bg: '#FFEDD5' },
  mosquito: { label: SERVICE_TYPE_LABELS.mosquito, icon: Wind, color: '#0369A1', bg: '#E0F2FE' },
  termite: { label: SERVICE_TYPE_LABELS.termite, icon: TreeDeciduous, color: '#166534', bg: '#DCFCE7' },
  ...
  flea: { label: SERVICE_TYPE_LABELS.flea, icon: Sparkles, color: '#A21CAF', bg: '#FAE8FF' },
  spider: { label: SERVICE_TYPE_LABELS.spider, icon: Bug, color: '#374151', bg: '#F3F4F6' },
  lizard: { label: SERVICE_TYPE_LABELS.lizard, icon: Leaf, color: '#15803D', bg: '#ECFDF5' },
  bee: { label: SERVICE_TYPE_LABELS.bee, icon: Flame, color: '#CA8A04', bg: '#FEF9C3' },
  wood_borer: { label: SERVICE_TYPE_LABELS.wood_borer, icon: Waves, color: '#92400E', bg: '#FEF3C7' },
  general: { label: SERVICE_TYPE_LABELS.general, icon: LayoutGrid, color: '#14532D', bg: '#E8F5EC' },
